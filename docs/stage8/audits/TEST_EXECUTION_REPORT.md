...
- Executed: `2026-08-04T15:32:14+09:00` to `2026-08-04T17:01:37+09:00`
...
| `python scripts/harness/audit_gate1_external_unblock.py` | 1 | Expected external-blocking exit: valid nominations 0/5, authority reference absent, missing roles 5/5, no assignment/dispatch/approval applied. |
