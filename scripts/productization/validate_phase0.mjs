...
if (status.project !== 'MathChakChak' || status.current_phase !== 11 || Object.keys(status.phases || {}).length !== 12 || status.phases?.['11']?.status !== 'VERIFIED') failures.push('PHASE_STATUS_INVALID');
