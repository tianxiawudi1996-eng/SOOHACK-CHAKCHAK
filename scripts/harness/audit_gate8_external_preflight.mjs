...
if (preflight.credential_boundary?.credential_value_accessed !== false || preflight.credential_boundary?.credential_value_stored !== false || preflight.credential_boundary?.raw_endpoint_stored !== false) failures.push('CREDENTIAL_BOUNDARY_INVALID');
