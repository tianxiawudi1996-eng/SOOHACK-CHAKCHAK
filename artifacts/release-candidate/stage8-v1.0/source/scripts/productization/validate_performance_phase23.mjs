...
if(total>PERFORMANCE_BUDGET.artifactLibraryBytesMax)fail(`artifact library total ${total}`);
if(largest>PERFORMANCE_BUDGET.artifactLibrarySingleAssetBytesMax)fail(`artifact library single asset ${largest}`);
...
console.log(`artifact_library_budget_bytes=${PERFORMANCE_BUDGET.artifactLibraryBytesMax}`);
